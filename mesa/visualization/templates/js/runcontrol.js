...
const initGUI = function (model_params) {
    ...
    var addBooleanInput = function (param, obj) {
        ...
        sidebar.append([
            ...
            "<p><label for='" + domID + "'>" + obj.name + "</label></p>",
    ...
    var addChoiceInput = function (param, obj) {
        ...
        var template = [
            "<p><label for='" + domID + "'>" + obj.name + "</label></p>",
            "<div class='dropdown'>",
            "<button id='" + domID + "' class='btn btn-secondary btn-lg dropdown-toggle' type='button' data-toggle='dropdown'>" +
            obj.value + " " + span,
            "</button>",
    ...
    var addTextBox = function (param, obj) {
        template = [
            '',
            '  <h3>',
            '<span class="badge badge-secondary">'+ obj.value +'</span>',
            '</h3>',
            ''
        ]
        sidebar.append(template.join(''));
